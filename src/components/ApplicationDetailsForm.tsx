    ...
    <form onSubmit={handleFormSubmit} className="flex flex-col gap-5 text-xs h-full" id="application-details-form-root">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-[var(--color-surface-2)]/40 border border-[var(--color-border)] rounded-xl">
        <div className="space-y-0.5">
          ...
          <div className={`text-xl font-bold ${ltv > 80 ? "text-red-400" : "text-[var(--color-accent)]"}`}>
        ...
        <div className="space-y-0.5 border-l border-[var(--color-border)] pl-4">
          ...
          <div className={`text-xl font-bold ${gds > 39 ? "text-red-400" : gds > 0 ? "text-green-500 font-semibold" : "text-[var(--color-text-faint)]"}`}>
      ...
      {/* 🧭 SECTION TABS */}
      <div className="flex border border-[var(--color-border)] bg-[var(--color-surface-2)] p-1 rounded-lg select-none">
      ...
      {/* 🛠️ TAB WORKSPACE */}
      <div className="flex-1 overflow-y-auto min-h-[300px] bg-[var(--color-surface)]/20 border border-[var(--color-border)] p-5 rounded-xl">
        
        {/* 1. PERSONAL ROSTER */}
        {activeSubTab === "personal" && (
          <div className="space-y-4" id="section-personal">
            <h4 className="text-[10px] text-[var(--color-accent)] uppercase font-black tracking-wider flex items-center gap-1.5 border-b border-[var(--color-border)] pb-1">
              Applicant Details
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" value={fields.app_marital || ""} onChange={(e) => handleFieldChange("app_marital", e.target.value)} placeholder="Single, Married, Divorced, etc." className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Social Insurance Number (SIN)</label>
                <input type="text" value={fields.app_sin || ""} onChange={(e) => handleFieldChange("app_sin", e.target.value)} placeholder="e.g. 8104" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                ...
                <input type="number" value={fields.beacon || ""} onChange={(e) => handleFieldChange("beacon", e.target.value)} placeholder="720" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Dependents</label>
                <input type="number" value={fields.app_dependents || "0"} onChange={(e) => handleFieldChange("app_dependents", e.target.value)} placeholder="0" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
            </div>

            <h4 className="text-[10px] text-[var(--color-accent)] uppercase font-black tracking-wider flex items-center gap-1.5 border-b border-[var(--color-border)] pt-4 pb-1">
              Co-Applicant Details (Optional)
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Co-Applicant First Name</label>
                <input type="text" value={fields.co_first || ""} onChange={(e) => handleFieldChange("co_first", e.target.value)} placeholder="Co First" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Co-Applicant Last Name</label>
                <input type="text" value={fields.co_last || ""} onChange={(e) => handleFieldChange("co_last", e.target.value)} placeholder="Co Last" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Co-Applicant Email</label>
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Co-Applicant SIN</label>
                <input type="text" value={fields.co_sin || ""} onChange={(e) => handleFieldChange("co_sin", e.target.value)} placeholder="SIN" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSubTab === "address" && (
          <div className="space-y-4" id="section-address">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Housing Status</label>
                <select value={fields.app_housing || ""} onChange={(e) => handleFieldChange("app_housing", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                ...
                <input type="text" value={fields.app_addr || ""} onChange={(e) => handleFieldChange("app_addr", e.target.value)} placeholder="123 Oak St" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Unit / Apt</label>
                <input type="text" value={fields.app_unit || ""} onChange={(e) => handleFieldChange("app_unit", e.target.value)} placeholder="Apt 4" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">City</label>
                <input type="text" value={fields.app_city || ""} onChange={(e) => handleFieldChange("app_city", e.target.value)} placeholder="Barrie" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Province</label>
                <input type="text" value={fields.app_prov || ""} onChange={(e) => handleFieldChange("app_prov", e.target.value)} placeholder="ON" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Postal Code</label>
                <input type="text" value={fields.app_post || ""} onChange={(e) => handleFieldChange("app_post", e.target.value)} placeholder="L4M 1X1" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                ...
                <input type="text" value={fields.app_res_yrs || ""} onChange={(e) => handleFieldChange("app_res_yrs", e.target.value)} placeholder="e.g. 5" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSubTab === "employment" && (
          <div className="space-y-4" id="section-employment">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Employment Status</label>
                <select value={fields.app_emp1_status || ""} onChange={(e) => handleFieldChange("app_emp1_status", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Employer / Company Name</label>
                <input type="text" value={fields.app_emp1_name || ""} onChange={(e) => handleFieldChange("app_emp1_name", e.target.value)} placeholder="Employer" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Job Title</label>
                <input type="text" value={fields.app_emp1_title || ""} onChange={(e) => handleFieldChange("app_emp1_title", e.target.value)} placeholder="Title" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Years on Job</label>
                <input type="text" value={fields.app_emp1_yrs || ""} onChange={(e) => handleFieldChange("app_emp1_yrs", e.target.value)} placeholder="Years" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Primary Salary / Income ($)</label>
                <input type="number" value={fields.app_emp1_income || ""} onChange={(e) => handleFieldChange("app_emp1_income", e.target.value)} placeholder="e.g. 95000" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Co-Applicant Income ($)</label>
                <input type="number" value={fields.co_emp1_income || ""} onChange={(e) => handleFieldChange("co_emp1_income", e.target.value)} placeholder="e.g. 60000" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSubTab === "property" && (
          <div className="space-y-4" id="section-property">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Estimated Purchase Price / Value ($)</label>
                <input type="number" value={fields.prop_value || ""} onChange={(e) => handleFieldChange("prop_value", e.target.value)} placeholder="e.g. 685000" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Property Type</label>
                <select value={fields.prop_type || ""} onChange={(e) => handleFieldChange("prop_type", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                ...
                <input type="text" value={fields.prop_style || ""} onChange={(e) => handleFieldChange("prop_style", e.target.value)} placeholder="e.g. Two Storey" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Tenure</label>
                <input type="text" value={fields.prop_tenure || ""} onChange={(e) => handleFieldChange("prop_tenure", e.target.value)} placeholder="e.g. Freehold" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
              <div>
                ...
                <input type="number" value={fields.prop_tax || ""} onChange={(e) => handleFieldChange("prop_tax", e.target.value)} placeholder="e.g. 4200" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Monthly Heating Utilities ($)</label>
              ...
              <div>
                ...
                <input type="text" value={fields.prop_age || ""} onChange={(e) => handleFieldChange("prop_age", e.target.value)} placeholder="e.g. 15" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSubTab === "mortgage" && (
          <div className="space-y-4" id="section-mortgage">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Mortgage Requested / Size ($)</label>
                <input type="number" value={fields.mtg1_balance || ""} onChange={(e) => handleFieldChange("mtg1_balance", e.target.value)} placeholder="e.g. 548000" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Interest Rate</label>
                <input type="text" value={fields.interestRate || ""} onChange={(e) => handleFieldChange("interestRate", e.target.value)} placeholder="e.g. 4.79%" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Amortization (Years)</label>
                <select value={fields.amortization || "25"} onChange={(e) => handleFieldChange("amortization", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Occupancy Type</label>
                <select value={fields.tenure || "owner-occupied"} onChange={(e) => handleFieldChange("tenure", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Lender Partner</label>
                <select value={fields.lender || ""} onChange={(e) => handleFieldChange("lender", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Assigned Agent</label>
                <select value={fields.agent || ""} onChange={(e) => handleFieldChange("agent", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none">
              ...
              <div>
                ...
                <input type="date" value={fields.maturityDate || ""} onChange={(e) => handleFieldChange("maturityDate", e.target.value)} className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none font-mono" />
              </div>
              <div>
                <label className="block text-[9px] text-[var(--color-text-muted)] uppercase font-black tracking-wider mb-1">Referred By</label>
                <input type="text" value={fields.referredBy || ""} onChange={(e) => handleFieldChange("referredBy", e.target.value)} placeholder="e.g. Broker Network" className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg p-2.5 text-xs text-[var(--color-text)] focus:outline-none" />
              </div>
            </div>
          </div>
        )}
      ...
      <button
        type="submit"
        className="w-full bg-[var(--color-accent)] text-[var(--color-bg)] font-black uppercase tracking-widest text-[10px] py-3 rounded-lg hover:bg-[var(--color-accent)]/85 hover:shadow-md transition-all flex items-center justify-center gap-1.5 shrink-0 cursor-pointer shadow"
      >
